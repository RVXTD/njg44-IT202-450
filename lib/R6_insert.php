<?php
require_once(__DIR__ . "/R6_api.php"); // for $TRAIL_ACTIVITIES

/**
 * Inserts a single r6 account into the DB.
 *
 * @param PDO $db
 * @param array $data account data (can be API or manual form)
 * @return bool True on success, false on failure
 */
function insert_account(PDO $db, array $data): bool
{
